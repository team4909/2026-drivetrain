...
public class ShooterIOTalonFX implements ShooterIO {
    ...
    private final int kShooterMotor1ID = 26;
    private final int kShooterMotor2ID = 27;
    // private final int kShooterMotor3ID = 28;
    private final int kShooterMotor4ID = 29;
    private final int kHoodRollerID = 30;
    private final String kCanbus = "CANivore2";
    ...
    public ShooterIOTalonFX() {
        ...
        shooterConfigs.Slot0.kP = 8.0;
        shooterConfigs.Slot0.kI = 0.0; 
        shooterConfigs.Slot0.kD = 0.1;
        ...
        hoodConfigs.Slot0.kP = 10.0;
        hoodConfigs.Slot0.kI = 0.0;
        hoodConfigs.Slot0.kD = 0.1;
        hoodConfigs.Slot0.kS = 0.0;
        hoodConfigs.TorqueCurrent.withPeakForwardTorqueCurrent(Units.Amps.of(40)).withPeakReverseTorqueCurrent(Units.Amps.of(-40));
        m_hoodRoller.getConfigurator().apply(hoodConfigs);
    ...
    public void setVelocity(double VelocityRPS) {
        ...
        m_hoodRoller.setControl(m_velocityTorque.withVelocity(Units.RotationsPerSecond.of(VelocityRPS * (18.0/7.0))));
    }

    @Override
    public void setDutyCycle(double dutyCycle) {
        m_goalVelocity = dutyCycle;
        m_shootermotor1.setControl(new DutyCycleOut(dutyCycle));
        m_shootermotor2.setControl(new DutyCycleOut(dutyCycle));
        // m_shootermotor3.setControl(m_velocityTorque.withVelocity(Units.RotationsPerSecond.of(-VelocityRPS)));
        m_shootermotor4.setControl(new DutyCycleOut(dutyCycle));
        m_hoodRoller.setControl(new DutyCycleOut(dutyCycle));
    }
    ...
    public void updateInputs(ShooterIOInputsAutoLogged m_inputs) {
        ...
        m_inputs.hoodRollerVelocityRPS = (7.0/18.0) * m_hoodRollerVelocity.getValueAsDouble();
        ...
        m_inputs.goalVelocity = m_goalVelocity;
        m_inputs.hoodRollerPIDOutput = m_hoodRoller.getClosedLoopOutput().getValueAsDouble();
    }
}
