...
public class TurretTrackPose extends Command {
    ...
    public TurretTrackPose(Turret turret, Pose2d goalPose, Supplier<Pose2d> robotPoseSupplier) {
        ...
        // Initialize rotational controller to avoid NPE. Fine-tune gains/constraints as
        // needed.
    ...
    public void initialize() {
        ...
        // Translation2d robotToTargetTranslation = poseInverse(new
        // Pose2d(currentRobotPose.getTranslation(), new Rotation2d())).transformBy(new
        // Transform2d(m_goalPose.getTranslation(), new Rotation2d())).getTranslation();
        // Rotation2d targetHeading =
        // robotToTargetTranslation.getAngle().rotateBy(Rotation2d.k180deg);
        // // m_rotationalController.setTolerance(Units.degreesToRadians(1.0));
    ...
    public void execute() {
        ...
        // m_turret.setDegrees(MathUtil.clamp(-targetHeading.getDegrees() +
        // currentRobotPose.getRotation().getDegrees() - 180, -90,90));
        // Logger.recordOutput("Turret/targetHeading", -targetHeading.getDegrees() +
        // currentRobotPose.getRotation().getDegrees() - 180);
        ...
        // }
        // }
        // Logger.recordOutput("Turret/robotBehindTarget",
        // robotBehindTarget(currentRobotPose, m_goalPose));
        ...
        // No extra 180-degree offset — wrapDegrees already gives the minimal signed
        // rotation
    ...
    // Field corner & hub definitions (placeholder coordinates — adjust to your
    // field origin/units)
    ...
    // Example hub position (center of field) — change if your coordinate system
    // differs
    private static final Pose2d HUB_POSE = new Pose2d(
            aprilTagLayout.getTagPose(26).orElse(new Pose3d()).toPose2d()
